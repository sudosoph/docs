...
When using Kraken behind Varnish be sure to [clear the Varnish cache]({{< relref "modules/overview/varnish-cache/how-tos/clearing-the-cache.md" >}})  to see the updated image.
